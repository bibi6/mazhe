...
\chapter{Ensembles}
\input{11_theorie_ensembles}

\chapter{Groupes et anneaux}
\input{12_groupes}
\input{13_anneaux}

\chapter{L'anneau des entiers, les groupes finis et les groupes abéliens}
\input{14_entiers}
\input{15_groupesFinisEtAbeliens}

\chapter{Corps de base}
\input{16_corps}
\input{21_reels}
\input{22_complexes}
...
\chapter{Modules, polynômes et matrices} \label{ChapMatricesPolyn}
\input{37_modules}
\input{38_matrices}

\chapter{Espaces vectoriels (début)}
\input{46_espacesVectos}
\input{48_espacesVectos}
...
\chapter{Topologie générale} \label{ChapTopologieGenerale}
\input{53_topologie}

\chapter{Un peu de topologie métrique}
\input{188_topologieDist}
\input{185_topologieDist}

\chapter{Topologie et analyse réelles}
\input{64_analyseR}
\input{65_analyseR}

\chapter{Topologie métrique}
%Il y avait 185_topologie avant ici. Maintenant le 185 est renommé et il est plus haut.
\input{199_topologie}
\input{54_topologieR}
...
\chapter{Analyse réelle à plusieurs variables}
\input{66_analyseR}
\input{173_analyseR}
\input{67_analyseR}
\input{68_analyseR}
