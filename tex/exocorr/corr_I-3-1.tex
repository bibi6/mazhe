...
\begin{corrige}{_I-3-1}
	...
	Nous vérifions facilement que toutes les hypothèses de la proposition  \ref{THOooZPUYooQAlUTa} sont satisfaites avec $\partial f/\partial x=0$, $\varphi(x)=a-x$ et $\psi(x)=a+x$. La formule donne alors
	\begin{equation}
