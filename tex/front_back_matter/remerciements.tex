...
%%----------------------------------------------------------------------------------------------------------------------------
%\subsection{Dans l'idéal \dots}
%%---------------------------------------------------------------------------------------------------------------------------
%Ce serait cool si:
%\begin{itemize}
%\item chaque chapitre ne comporterait que 10 sections maximum, et ainsi de suite\dots
%\item chaque chapitre ne contenait que 100 résultats au maximum,
%\item et que chaque fichier ne contenait que 1000 lignes de code...
%\end{itemize}
