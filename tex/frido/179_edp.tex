    ...
    \begin{subproof}
        \item[\( Lu\geq \eta>0\)]
            ...
            \begin{equation}
                (Lu)(x_0)=(L'u)(x_0)> 0,
            \end{equation}
            ce qui contredit le lemme~\ref{LEMooSPVUooDQOeom}. Nous en déduisons que le minimum de \( u\) sur \( \bar \Omega\) n'est pas atteint dans \( \Omega\), mais sur \( \partial\Omega\). Pour la définition de la frontière, voir~\ref{PropDescFrpbsmI}. Ici nous avons \( \bar\Omega\setminus\Omega=\partial\Omega\).
