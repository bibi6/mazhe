...
\begin{definition}      \label{DEFooXNAFooGTbTTJ}
    Une \defe{transposition}{transposition} est une permutation qui inverse deux éléments. Plus précisément, une bijection \( \sigma\colon E\to E\) est une transposition si il existe \( a,b\in E\) tels que \( a \neq b \) et \( \sigma (a) = b;\ \sigma(b) = a;\ \sigma(x) = x \) pour tout autre \( x \in E \).
\end{definition}
