...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[\( A\) est l'intersection des \( V_n\)]
            ...
            Nous avons évidemment \( A\subset V_n\) pour tout \( n\). Et d'autre part, si \( a\in\bigcap_{n\in \eN} V_n\) alors \( d(a,A)<\frac{1}{ n }\) pour tout \( n\). Cela implique \( d(a,A)=0\), et donc \( a\in A\) par le lemme \ref{LEMooAIARooQADaxM}.%proposition~\ref{PropGULUooNzqZKj}.
