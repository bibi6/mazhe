...
\begin{lemma}
    Une suite de Cauchy\footnote{Définition~\ref{DefZSnlbPc}.} dans un espace vectoriel normé admettant une sous-suite convergente est elle-même convergente vers la même limite.
\end{lemma}
