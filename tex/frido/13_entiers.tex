...
Nous introduisons ici la fonction indicatrice d'Euler et quelques-unes de ses propriétés basiques. Pour les propriétés plus avancées, voir~\ref{subSecKGDFooAbETjs}.

\begin{definition}      \label{DEFooWYIGooRVBTil}
On note \( \Delta_n \) l'ensemble \( \Delta_n = \{ k \in \eN \tq k < n \text{ et } \pgcd(k,d)=1\} \).
