...
\begin{example}[Voisinages de réels]
  Pour qu'un ensemble soit un voisinage de $x \in \eR$, il faut et il suffit qu'il contienne un intervalle ouvert\footnote{Pouvez-vous le justifier? Pensez à la proposition~\ref{PropMMKBjgY}\dots}. Ainsi, les ensembles suivants sont des voisinages de $3$ dans $\eR$ :
  \begin{itemize}
  \item
