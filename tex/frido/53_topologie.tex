...
Soit $f\colon A\subset\eR^n\to B\subset\eR^m$ une bijection continue. Si $A$ est compact, alors l'application réciproque \footote{Définition \ref{DEFooTRGYooRxORpY}.} $f^{-1}\colon B\to A$ est continue.
\end{proposition}
